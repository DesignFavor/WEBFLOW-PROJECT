  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <skinnedMesh castShadow receiveShadow name="10294136_0" geometry={nodes['10294136_0'].geometry} material={materials['Material.003']} skeleton={nodes['10294136_0'].skeleton} position={[-0.012, 0.234, -1.315]} rotation={[Math.PI / 2, 0, 0]} scale={0.741} />
